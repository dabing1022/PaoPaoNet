			...
			switch(e.keyCode){
				case 49:   //键盘1号键
					if(_skillBar.bulletBoxView1.isEmpty)
						return;
					if(_skillBar.bulletBoxView2.isSelected || _skillBar.bulletBoxView3.isSelected){
				...
				case 50:   //键盘2号键
					if(_skillBar.bulletBoxView2.isEmpty)
						return;
					if(_skillBar.bulletBoxView1.isSelected || _skillBar.bulletBoxView3.isSelected){
				...
				case 51:   //键盘3号键
					if(_skillBar.bulletBoxView3.isEmpty)
						return;
					if(_skillBar.bulletBoxView1.isSelected || _skillBar.bulletBoxView2.isSelected){
						disShowSelectedAni(0);
						disShowSelectedAni(1);
					}
